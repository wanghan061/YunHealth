...
public class WardInspection extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ward_list);
        initTitle();
        initView();
        getBedInfo();
        addRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WardInspection.this, AddWardRecord.class);
        ...
        IStringRequest request = new IStringRequest(Request.Method.POST, Constants.SERVER_ADDRESS +
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(WardInspection.this,"服务器连接出现问题", Toast.LENGTH_SHORT).show();
                    }
                });
        queue.add(request);
    }
        ...
        try {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(WardInspection.this, WardInspectRecord.class);
    ...
    public void initView() {
        addRecord = (Button) findViewById(R.id.btn_add);
