...
public class HealthList extends BaseActivity {
    ...
    private void getPatientInfo() {
        ...
        try {
            request = new StringRequest(Request.Method.POST, Constants.SERVER_ADDRESS +
                    "servlet/TemperatureDepartmentQueryServlet?department=" + URLEncoder.encode(department, "UTF-8"),
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            Toast.makeText(HealthList.this, "服务器连接出现问题", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        try {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent intent = new Intent(HealthList.this, FileContext.class);
    ...
    public void initView() {
        ...
        SharedPreferences pref1 = getSharedPreferences("userdata",MODE_PRIVATE);
        department = pref1.getString("department","");
