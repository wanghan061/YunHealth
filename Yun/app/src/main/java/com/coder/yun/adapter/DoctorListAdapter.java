...
public class DoctorListAdapter extends BaseAdapter {
    ...
    public DoctorListAdapter(List<Map<String, Object>> list1, Context context) {
        this.list1 = list1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        hold.textView1.setText(list1.get(position).get("name").toString());
        hold.textView2.setText(list1.get(position).get("department").toString());
