...
import com.coder.yun.adapter.PatientAppointAdapter;
...
public class PatientMyAppoint extends BaseActivity {

    private ListView listView;
    String userName;
    private List<Map<String, Object>> list1 = new ArrayList<>();
    private PatientAppointAdapter adapter;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.appoint_patient);
        initTitle();
        initView();
    }
    ...
    private void hoslist() {
        ...
        IStringRequest request = new IStringRequest(Request.Method.GET, Constants.SERVER_ADDRESS +
                "servlet/AppointmentLookServlet?userName=" + userName,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(PatientMyAppoint.this, "服务器连接出现问题", Toast.LENGTH_SHORT).show();
                    }
                });
        queue.add(request);
    }
    ...
    private void parsedoc(String s) {
        ...
        try {
            ...
            list1 = doctors;
            adapter = new PatientAppointAdapter(list1, getBaseContext());
