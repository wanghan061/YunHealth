...
public class BedDetail extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bed_detail);
        initTitle();
        initView();
        getHealthInfo();
    }
            ...
            request = new IStringRequest(Request.Method.POST, Constants.SERVER_ADDRESS +
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            Toast.makeText(BedDetail.this, "服务器连接出现问题", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void initView() {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BedDetail.this, BedDetailChange.class);
