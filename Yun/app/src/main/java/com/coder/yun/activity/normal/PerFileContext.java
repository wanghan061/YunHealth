...
public class PerFileContext extends BaseActivity {
    ...
    private void getInfo() {
        ...
        request = new StringRequest(Request.Method.GET, Constants.SERVER_ADDRESS +
                "servlet/TemperaturePatientQueryServlet?userName=" + userName,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        Toast.makeText(PerFileContext.this, "服务器连接出现问题", Toast.LENGTH_SHORT).show();
                    }
                });
        queue.add(request);
    }
