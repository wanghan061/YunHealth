...
public class NorAdviceListAdapter extends BaseAdapter {

    private List<Map<String, Object>> list1 = new ArrayList<>();
    //List<String> list = new ArrayList<>();
    private Context context;

    public NorAdviceListAdapter(List<Map<String, Object>> list1, Context context) {
        this.list1 = list1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        hold.textView1.setText(list1.get(position).get("doctorName").toString());
